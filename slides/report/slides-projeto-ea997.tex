...
\begin{frame}
	...
	\indent{Foi utilizada a linguagem \textbf{Python 3}, mais precisamente, as bibliotecas \textbf{Scikit-Learn} e \textbf{TensorFlow} e a base de dados\doingles{Dataset} \textbf{MIT-BIH} \cite{moody2001impact}, que contém dados de 47 pessoas de 23 a 89 anos, incluindo homens e mulheres.}
...
\begin{frame}
	...
	\indent{Após carregar as séries temporais, os dados foram normalizados utilizando a técnica \textit{z-score}, definida abaixo:
	\begin{equation}
		x' = \frac{x - \mu}{\sigma},
	\end{equation}
...
\indent{Vale-se mencionar que os espectros de frequência foram obtidos utilizando-se a transformada rápida de Fourier.}
