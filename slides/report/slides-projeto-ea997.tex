...
\begin{frame}
	...
	\indent{O dado foi digitalizado com uma frequência de $\SI{360}{\hertz}$ e cada sinal dura $\SI{1}{s}$, ou seja, cada sinal é um conjunto de $360$ valores e, por fim, foi utilizada a derivação derivação precordial (V2).}
...
\begin{frame}
	...
	\indent{A base de dados foi balançeada para que todas as classes tenham a mesma proporção no conjunto final, ou seja, haja o mesmo número de sinais em todos os tipos de batimentos cardíacos presentes nos sinais de ECG.}
\end{frame}	
